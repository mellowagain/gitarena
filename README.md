...
- [x] Repository management
  ...
  - [x] Tag listing
  - [x] Releases
    - [ ] Autogenerated changelogs from merged MRs
    - [x] Asset upload
...
- [ ] Commit/MR cross-linking

### Stretch goals

- [ ] Federation via ForgeFed/AT Proto
- [ ] VS Code / JetBrains IDE integration
- [ ] Review iteration tracking: show what changed between force-pushed versions of a MR (like Gerrit's patchset model)
- [ ] Merge queue
