...
| `ssh.private_key` | Generated | Private host key stored after first startup |
...
The following public key types are accepted:

| Key type                             | Algorithm                           |
|--------------------------------------|-------------------------------------|
| `ssh-ed25519`                        | Ed25519                             |
| `sk-ssh-ed25519@openssh.com`         | Ed25519 (FIDO/U2F security key)     |
| `ecdsa-sha2-nistp256`                | ECDSA P-256                         |
| `ecdsa-sha2-nistp384`                | ECDSA P-384                         |
| `ecdsa-sha2-nistp521`                | ECDSA P-521                         |
| `sk-ecdsa-sha2-nistp256@openssh.com` | ECDSA P-256 (FIDO/U2F security key) |
| `ssh-rsa`                            | RSA (SHA-1)                         |
